...
namespace 슈팅게임만들기
{
    ...
    public class Player
    {
        ...
        public void KeyControl()
        {
            ...
            {
                pressKey = _getch(); //아스키값 상하좌우
                if (pressKey == 224) pressKey = _getch();

                switch (pressKey)
                {
                    case 72: //위쪽
                        playerY--; if (playerY < 1) playerY = 1; break;
                    case 75: //왼쪽 
                        playerX--; if (playerX < 0) playerX = 0; break;
                    case 77: //오른쪽
                        playerX++;if (playerX > 75) playerX = 75;break;
                    case 80: //아래
                        playerY++;if (playerY > 21) playerY = 21;break;
                    case 32: //스페이스바
                        //총알 발사
                        for (int i = 0; i < 20; i++)
                        {
                        ...
                        {
                            //미사일이 false 발사가능
                            if (playerBullet2[i].isFire == false)
                            {
                        ...
                        {
                            //미사일이 false 발사가능
                            if (playerBullet3[i].isFire == false)
                            {
        ...
        public void BulletDraw()
        {
            ...
            for (int i = 0; i < 20; i++)
            {
                ...
                if (playerBullet[i].isFire == true)
                {
                    ...
                    {
                        playerBullet[i].isFire = false; //미사일 false 다시 준비상태
                    }
        ...
        public void BulletDraw2()
        {
            ...
            {
                //미사일이 살아있는 상태
                if (playerBullet2[i].isFire == true)
                {
                    ...
                    {
                        playerBullet2[i].isFire = false;  //미사일 false 다시 준비상태
                    }
                }
            }
        }
        ...
        public void BulletDraw3()
        {
            ...
            {
                //미사일이 살아있는 상태
                if (playerBullet3[i].isFire == true)
                {
                    //좌표설정 -> 중간위치를 위해 보정을 위해 x-1
                    ...
                    {
                        playerBullet3[i].isFire = false;  //미사일 false 다시 준비상태
                    }
                }
            }
        }
                ...
                if (playerBullet[i].isFire == true)
                {
                    ...
                    if (playerBullet[i].y == enemy.enemyY)
                    {
                            ...
                            && playerBullet[i].x <= (enemy.enemyX + 1)) //충돌
                        {
                            ...
                            playerBullet[i].isFire  = false; //미사일 준비상태로 만들어주기
                ...
                if (playerBullet2[i].isFire == true)
                {
                    ...
                    if (playerBullet2[i].y == enemy.enemyY)
                    {
                            ...
                            && playerBullet2[i].x <= (enemy.enemyX + 1)) //충돌
                        {
                            ...
                            playerBullet2[i].isFire = false; //미사일도 준비상태로 만들어주기
                ...
                if (playerBullet3[i].isFire == true)
                {
                    ...
                    if (playerBullet3[i].y == enemy.enemyY)
                    {
                            ...
                            && playerBullet3[i].x <= (enemy.enemyX + 1)) //충돌
                        {
                            ...
                            playerBullet3[i].isFire = false; //미사일도 준비상태로 만들어주기
    ...
    public class Enemy
    {
        public int enemyX,enemyY; //X,y좌표
